...
**Status:** Direction for the next visual redesign  
...
| Linear violet | `#7C6CFF` | Core command signal and brand continuity |
| Electric violet | `#A897FF` | Perfect hits and Flow State |
